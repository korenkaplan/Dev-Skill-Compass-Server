...
expected_result_extract_keys_from_dictionary = ['programming_languages', 'databases', 'cloud_platforms',
                                                'web_frameworks', 'other_frameworks', 'other_tools',
                                                'integrated_development_environment', 'async_tools',
                                                'synchronous_tools', 'version_control_tech', 'data_analyst_tools',
                                                'testing_and_qa_tools', 'data_exchange_apis_and_tools',
                                                'messaging_queues_tech', 'methodologies', 'code_architecture',
