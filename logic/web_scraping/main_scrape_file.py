...
from utils.settings import SHOW_FULL_DESCRIPTION_BUTTON_XPATH_GOOGLE_JOBS, \
    EXPANDABLE_JOB_DESCRIPTION_TEXT_XPATH_GOOGLE_JOBS, NOT_EXPANDABLE_JOB_DESCRIPTION_TEXT_XPATH_GOOGLE_JOBS
