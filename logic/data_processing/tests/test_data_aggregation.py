...
#     # region Tests
#
#     def test_assign_aggregated_dict_to_role(self):
#         """Test creating an object from the role and the aggregated data"""
#         expected_result = {role_name_for_assign_aggregated_dict_to_role:
...
#
#     def test_divide_words_into_categories(self):
...
#
#     def test_group_synonyms_words(self):
...
#
#     def test_sum_results_of_job_listings_analysis(self):
...
#
#     def test_compare_lengths_(self):
