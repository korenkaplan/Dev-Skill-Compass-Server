...
def get_proxies_objects_list(url: str = 'https://free-proxy-list.net/',
                             element_class: str = 'table table-striped table-bordered',
...
def get_proxies_list(url: str = 'https://free-proxy-list.net/',
                     element_class: str = 'table table-striped table-bordered',
                     proxy_validation_url="http://ipinfo.io/json"):
